# Autogenerated wrapper script for pocl_jll for aarch64-linux-musl-cxx11
...
function __init__()
    JLLWrappers.@generate_init_header(OpenCL_jll, OpenCL_Headers_jll, Hwloc_jll, Zstd_jll, SLEEF_jll)
